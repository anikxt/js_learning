...
document.addEventListener('keydown', (e) => {
  if (e.repeat) return; // called as guard class
  // it guards you from contuining your function any further and it's usually at the top of yor function
...
// 'toggle' function allows us to turn something on or off depending on the variable
...
/* Understanding part -
    keyDown functiom
    KeyUp function
    How we use the global object throughout the code
*/
